...
namespace BookingSystem.Persistence.Migrations
{
    ...
    [Migration("20240918015225_eventcopy22")]
    partial class eventcopy22
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookingSystem.Domain.Entities.Events.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            End = new DateTime(2024, 9, 23, 12, 0, 30, 791, DateTimeKind.Local),
                            Label = "primary",
                            Start = new DateTime(2024, 9, 23, 10, 30, 30, 791, DateTimeKind.Local),
                            Title = "Conference 1"
                        },
                        new
                        {
